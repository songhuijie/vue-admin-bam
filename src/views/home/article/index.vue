    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="auto" style="width: 90%; margin-left:50px;">
        <el-form-item label="类型" prop="cate_id">
          <el-select v-model="temp.cate_id" class="filter-item" placeholder="Please select">
        ...
        <el-form-item label="内容" prop="content">
          <div>
            <tinymce v-if="dialogFormVisible" v-model="temp.content" :height="300" />
          </div>
        </el-form-item>
      </el-form>
...
import { fetchList, createArticle, updateArticle, deleteArticle } from '@/api/home/article/article'
